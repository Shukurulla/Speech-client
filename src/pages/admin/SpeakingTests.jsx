...
import { FiMic, FiPlus, FiEdit2, FiTrash2, FiList } from "react-icons/fi";

const AdminSpeakingTests = () => {
  ...
  const fetchTests = async () => {
    ...
    try {
      ...
      // Filter for speaking tests only
      const speakingTests = data.data.filter(
        (test) =>
          test.lessonId === selectedLesson &&
          (!test.type || test.type === "speech")
      );
  ...
  const handleSubmit = async (e) => {
    ...
    const testData = {
      ...
      type: "speech", // Always speaking for this page
    };
  ...
  const handleDelete = async (testId) => {
    if (window.confirm("Are you sure you want to delete this speaking test?")) {
      try {
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">
              Speaking Tests Management
            </h1>
            <p className="text-gray-600">Manage speaking tests for lessons</p>
          </div>
          <button
        ...
        {selectedLesson ? (
            ...
            {isLoading ? (
              ...
              <div className="col-span-full text-center py-12">
                ...
                <p className="text-gray-600 mb-4">
                  Create the first speaking test for this lesson.
                </p>
                <button
                  onClick={openCreateModal}
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">
              Choose a grade and lesson to manage speaking tests.
            </p>
          </div>
        )}
...
// Shared Test Card Component
const TestCard = ({ test, onEdit, onDelete, onManageDetails, icon, color }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
      ...
      <button
        ...
        className={`w-full ${buttonColor} text-white py-2 px-4 rounded-lg font-medium transition-colors flex items-center justify-center gap-2`}
      >
        <FiList size={16} />
        Manage Questions
      </button>
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-gray-900">
              {test ? "Edit" : "Create"} {testType} Test
            </h2>
            <button
              onClick={onClose}
        ...
        <form onSubmit={onSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              placeholder={`Enter ${testType.toLowerCase()} test title`}
              required
            />
          </div>
          ...
          <div className="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-bold text-gray-900">
                    Manage {testType} Questions: {test?.title}
                  </h2>
                  <p className="text-sm text-gray-600 mt-1">
                    Add and manage {testType.toLowerCase()} test questions
                  </p>
                </div>
            ...
            <form onSubmit={handleAddDetail} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder={
                    testType === "Speaking"
                      ? "e.g., Read aloud the following text"
                      : "e.g., Listen and write what you hear"
                  }
                  required
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={
                    testType === "Speaking"
                      ? "Enter the text that the student should read/speak..."
                      : "Enter the text that will be converted to speech..."
                  }
                  rows={4}
                  required
                />
                <p className="text-xs text-gray-500 mt-1">
                  {testType === "Speaking"
                    ...
                    : "This text will be converted to speech for the student to listen to"}
                </p>
              </div>
